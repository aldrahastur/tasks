<button class="c-header-toggler c-class-toggler d-lg-none mfe-auto" type="button" data-target="#sidebar" data-class="c-sidebar-show">
    <div class="c-icon c-icon-lg">
        <use xlink:href="vendors/@coreui/icons/div/free.div#cil-menu"></use>
    </div>
</button><a class="c-header-brand d-lg-none c-header-brand-sm-up-center" href="#">
    <div width="118" height="46" alt="CoreUI Logo">
        <use xlink:href="assets/brand/coreui-pro.div#full"></use>
    </div></a>
...
<ul class="c-header-nav">
    <li class="c-header-nav-item dropdown d-md-down-none mx-2"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            ...
            </div><span class="badge badge-pill badge-danger">5</span></a>
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
            <div class="dropdown-header bg-light"><strong>You have 5 notifications</strong></div><a class="dropdown-item" href="#">
                ...
                </div> New user registered</a><a class="dropdown-item" href="#">
                <div class="c-icon mfe-2 text-danger">
                    <i class="fas fa-user-times"></i>
                </div> User deleted</a><a class="dropdown-item" href="#">
    ...
    <li class="c-header-nav-item dropdown d-md-down-none mx-2"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            ...
            </div><span class="badge badge-pill badge-warning">15</span></a>
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
...
<div class="progress-bar bg-success" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
    ...
    <li class="c-header-nav-item dropdown d-md-down-none mx-2"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            <div class="c-icon">
                <use xlink:href="vendors/@coreui/icons/div/free.div#cil-envelope-open"></use>
            </div><span class="badge badge-pill badge-info">7</span></a>
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
    ...
    <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu dropdown-menu-right pt-0">
            <div class="dropdown-header bg-light py-2"><strong>Account</strong></div><a class="dropdown-item" href="#">
                ...
                <div class="c-icon mfe-2">
                    <use xlink:href="vendors/@coreui/icons/div/free.div#cil-envelope-open"></use>
                </div> Messages<span class="badge badge-success mfs-auto">42</span></a><a class="dropdown-item" href="#">
                <div class="c-icon mfe-2">
                    <use xlink:href="vendors/@coreui/icons/div/free.div#cil-task"></use>
                </div> Tasks<span class="badge badge-danger mfs-auto">42</span></a><a class="dropdown-item" href="#">
                <div class="c-icon mfe-2">
    ...
    <button class="c-header-toggler c-class-toggler mfe-md-3" type="button" data-target="#aside" data-class="c-sidebar-show">
        <div class="c-icon c-icon-lg">
            <use xlink:href="vendors/@coreui/icons/div/free.div#cil-applications-settings"></use>
        </div>
    </button>
</ul>
